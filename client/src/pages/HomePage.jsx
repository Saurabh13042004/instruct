...
function HomePage() {
  ...
  return (
    <>
      <main className="w-[98vw] overflow-hidden px-4 md:px-10">
        {/* --------------------------------
              ...
              <div className="row align-items-center">
                ...
                <div className="col-xl-6 col-lg-6 order-last order-lg-first">
                  <div className="slider__img__box mb-50 pr-30">
                    ...
                    <img className="slide-shape img-three" style={{ top: '20%' }} src="./assets/img/shape/target.svg" alt="" />
                    <img className="slide-shape img-four" src="./assets/img/shape/dot-box-1.svg" alt="" />
                    <img className="slide-shape img-five" style={{ top: '-170px' }} src="./assets/img/shape/dot-box-2.svg" alt="" />
              ...
              <div className="row mb-85">
                <div className="col-xl-6 col-lg-6 col-md-6">
                  ...
                  >
                    ...
                    <Link to='/course/67e7e229fe1551f16474dd91' className="theme_btn border_btn">
                      Explore Now
                    </Link>
                  </div>
                </div>
        ...
        {/* --------------------------------
            Why Choose Us
        -------------------------------- */}
        <div className="why-chose-section-wrapper gradient-bg scroll-fade-in">
                  ...
                  <div className="col-xl-7 col-lg-7">
                    <div className="chose-img-wrapper mb-50 pos-rel">
                      ...
                      <div className="video-wrapper">
                        <a
                          href="https://www.youtube.com/@Instruct-edu"
